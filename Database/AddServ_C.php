...
<center><form action=save_serv_c.php method=post enctype="multipart/form-data">
<div class="header-w3l">
			<h1>Add Your Service Center</h1>
		</div><br>
	<div class="box">
	<div class="field">Service Centre Name&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;
	<input class="options" type=text name="name" required></div>
	<br>
	<div class="field">Upload your centre picture&nbsp;&nbsp;:&nbsp;&nbsp;
...
<?php
	...
	<select class='options' name=type onblur='search(this.value)'>
		...
		<div class='field'>Brand dealing with &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;
