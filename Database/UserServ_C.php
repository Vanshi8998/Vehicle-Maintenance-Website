...
<?php
echo "<center><form method=post action=search_serv_c.php>
<p class='head'>Find Service Centre </p>
	...
	<div id='myCarousel' class='carousel slide  ' data-ride='carousel'>
		...
		<div class='carousel-inner'>
			<div class='item active'>
				<img src='service3.jpg' alt='service3' width='500px' height='200px'>
			</div>

			<div class='item'>
				<img src='service5.jpg' alt='service5' width='500px' height='200px'>
			</div>
